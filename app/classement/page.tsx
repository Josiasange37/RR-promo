        ...
        {loading ? (
          ...
          <>
                  ...
                  {[roiRankings[0], reineRankings[0]].filter(Boolean).map((leader) => (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-white/40 mt-1">{leader.class} · Promo 2026</p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <RankingTable title="Roi de Promo" color="#e8c26a" Icon={Crown} candidates={roiRankings} onVote={openVoteModal} />
              <RankingTable title="Reine de Promo" color="#d04a58" Icon={Gem} candidates={reineRankings} onVote={openVoteModal} />
            </div>
        ...
        >
          ...
          >
            ...
            <div>
              ...
              <p className="text-xs text-white/40 mt-1">{selectedCandidate.category} de Promo · {selectedCandidate.class}</p>
            </div>
