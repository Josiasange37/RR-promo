...
const FAQ = [
  ...
  },
  {
    ...
    a: "Les votes sont ouverts jusqu'au jour de l'événement, le 9 août 2026. Le classement final sera annoncé lors du Bal Masqué. Profitez-en pour voter avant la clôture !",
  },
  {
    ...
    <main className="min-h-screen text-white overflow-x-hidden" style={{ background: "#101014" }}>
      ...
      >
        <div className="max-w-4xl mx-auto px-4 sm:px-6 md:px-12 pt-20 pb-16 text-center">
          ...
          >
            Tout ce que vous devez savoir pour participer à l&apos;élection du Roi et de la Reine du{" "}
            <strong style={{ color: "rgba(255,255,255,0.7)" }}>Bal Masqué 2026</strong>.
          </p>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <p className="text-sm leading-relaxed mb-4" data-reveal style={{ color: "rgba(255,255,255,0.5)" }}>
              Chaque année au Bal Masqué, les participant·es et leurs proches élisent démocratiquement un <strong style={{ color: "#e8c26a" }}>Roi</strong> et une{" "}
            ...
            <p className="text-sm leading-relaxed" data-reveal style={{ color: "rgba(255,255,255,0.5)" }}>
              ...
              <strong style={{ color: "#e8c26a" }}>100 FCFA</strong>. Les fonds collectés contribuent directement au financement du Bal Masqué.
            </p>
          </div>
      ...
      >
        <div className="max-w-2xl mx-auto px-4 text-center">
          ...
          <p className="text-base mb-10 leading-relaxed" data-reveal style={{ color: "rgba(255,255,255,0.45)" }}>
            ...
            <strong style={{ color: "#d04a58" }}>Reine</strong> du Bal Masqué 2026.
          </p>
