        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6">
          <div>
            ...
            <p className="text-xs text-neutral-400 mt-1">
              Deux niveaux d&apos;accès : <b className="text-[#e8c26a]">Accès complet</b> (propriétaire : gère les comptes, paiements, retraits) et <b className="text-neutral-200">Modération</b> (modère les votes/candidats). Chaque compte se connecte avec un mot de passe ET un code d&apos;authentification à 6 chiffres (Google Authenticator, Authy…). Le bouton « Mot de passe » permet de générer un nouveau mot de passe en cas de perte.
            </p>
          </div>
                ...
                <div className="flex items-center gap-3 flex-wrap">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      title="Récupérer un mot de passe perdu — génère un nouveau mot de passe"
                    >
          ...
          <div className="p-5 sm:p-6 md:p-8">
            ...
            {modal.created ? (
              ...
              <>
                ...
                <p className="text-xs text-neutral-400 mt-2">
                  Le compte pourra accéder au panneau de modération. Un mot de passe sécurisé sera généré et affiché une seule fois, puis assignez un authentificateur pour la double vérification.
                </p>
